...
I dag designede vi så en dobbeltclicker, der kan forbinde det yderste tandbørsteled, hvor tandbørstehovedet sidder med et samlerled, hvorved vi opnår drejemekanismen, da denne clicker er loose. Vi fik indsat de runde huller vi skulle bruge fra Tobias' system i nogle små runde samleled, hvor det ene har hul hele vejen igennem, så clickeren kan klikke videre ind i den øverste cylinder på tandbørsten, og det andet lukkes efter hullet, så man i teorien kunne lime tandbørstehår på. Vi fortsætter i morgen.

![ToothbrushSketch.jpeg](Images/ToothbrushSketch.jpeg)

# Torsdag den 21. september 2023 - Toothbrush

I dag fik vi modelleret resten af tandbørsten minus den del der skulle muliggøre at man kunne skille selv håndtaget ad vha clickerne for at indsætte batterier. Der mangler i princippet selvfølgelig mange andre features, hvis alt elektronikken skulle kunne indsættes, men målet var en modellering af selve formen inkl diverse clickere og det nåede vi frem til. Der er nu også tilføjet den øverste og den nederste cylinder, som begge klikkes sammen vha tight dobbeltclickere, da der intet behov er for fleksibilitet her, det skal bare sidde sammen og blive der.
...
Jeg tog ind for at lave et par testprints af samleren (griberne og cylinderen, der skal samle æskens top og bund), så vi kan komme videre med udviklen af skattekisten. Vi eksperimenterede med at printe griberen stående med "armene" op i luften uden support, og det blev vellykket. Cylinderne til bunden, der har huller nedenunder, får support i hullerne, og det var lige til at få ud bagefter, så det fungrerer også. Den printer med blåt materiale printede mest præcist, og det er vi afhængige af, når komponeneterne er så små, så der blev lavet et ekstra sæt gribere i blå. Cylinderen blev som den skulle i første go. I morgen kan vi så sætte komponenterne fast på selve æsken, så den kan printes i sin helhed.

https://github.com/malenec/RoAE23/assets/90346924/3670faa9-52a6-4522-923a-97f8e5b891cd

https://github.com/malenec/RoAE23/assets/90346924/32f93b4f-349d-4e31-8c5a-c254ad4af922
